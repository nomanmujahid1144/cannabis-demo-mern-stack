...
export const addBlog = (aboutData, blogHeading , headerImage , navigate, alert , isOpen , setIsOpen) => {

    return async (dispatch) => {
        dispatch(selectProgressBarState(true))
        const res = await axiosInstance.post('/api/v1/blog/addblog', {
            data: aboutData,
...
export const updateBlog = (id , aboutData, blogHeading , headerImage , navigate, alert, isOpen, setIsOpen) => {
    return async (dispatch) => {
        dispatch(selectProgressBarState(true))

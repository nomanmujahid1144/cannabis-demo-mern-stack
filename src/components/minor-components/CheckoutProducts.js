                    ...
                    <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6 ">
                        <div className="flex flex-col rounded-lg bg-white sm:flex-row relative">
                            ...
                            {product.cartProductQuantity !== 0 ? (
                                <>
                                    <div className="flex w-full flex-col px-4 py-4 text-textColor">
                                        ...
                                        {product.cartExtras.map((extra, index) => (
                                            <div className="w-100 grid grid-cols-6 md:grid-cols-6 items-center">
                                                <div className="flex col-span-4 gap-3">
                                                    ...
                                                    <span key={index} className="float-right text-textColor">${extra.cost} x {extra.quantity}  =
                                                        <span key={index} className="text-lg font-bold text-textColor"> ${extra.cost * extra.quantity}</span>
                                                    </span>
                                                </div>

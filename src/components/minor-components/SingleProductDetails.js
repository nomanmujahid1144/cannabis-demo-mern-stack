...
export const SingleProductDetails = (props) => {
    ...
    return (
        <>
            {!loading ?
                <div className='w-full h-[85vh] flex text-textColor'>
                    <div className='w-full  grid lg:grid-cols-2  md:grid-cols-2 sm:grid-col-1 overflow-x-auto'>
                        <div className="w-12/12">
                            <div style={{ scrollbarWidth: 'thin' }} className=" h-full mx-auto overflow-hidden">
                                <div className="w-full shadow-[0px_3px_12px_rgba(0,0,0,0.1)] py-2">
                                    <div className="w-full lg:w-full  text-textColor text-md font-semibold md:w-full bg-white rounded-lg text-start pl-2">{props.item.name}</div>
                                </div>
                                <div className="h-[100%] w-full p-4 bg-primaryColorLight">
                                    <div>
                                    ...
                                    <div className="my-4">
                                        ...
                                        <div className="w-full bg-gray-200 rounded-full mt-2 ">
                                            <div className="bg-primaryColor text-xs h-2.7 font-medium text-textColorWhite text-center p-0.5 leading-none rounded-full" style={{ width: `${props.item.effects.uplifted}%` }}> {props.item.effects.uplifted}%</div>
                                        </div>
                                        <p className="text-sm font-medium mt-1">Euphoric</p>
                                        <div className="w-full bg-gray-200 rounded-full mt-2 ">
                                            <div className="bg-primaryColor text-xs h-2.7 font-medium text-textColorWhite text-center p-0.5 leading-none rounded-full" style={{ width: `${props.item.effects.euphoric}%` }}> {props.item.effects.euphoric}%</div>
                                        </div>
                                        <p className="text-sm font-medium mt-1">Energetic</p>
                                        <div className="w-full bg-gray-200 rounded-full mt-2 ">
                                            <div className="bg-primaryColor text-xs h-2.7 font-medium text-textColorWhite text-center p-0.5 leading-none rounded-full" style={{ width: `${props.item.effects.energetic}%` }}> {props.item.effects.energetic}%</div>
                                        </div>
                                        <p className="text-sm font-medium mt-1">Creative</p>
                                        <div className="w-full bg-gray-200 rounded-full mt-2 ">
                                            <div className="bg-primaryColor text-xs h-2.7 font-medium text-textColorWhite text-center p-0.5 leading-none rounded-full" style={{ width: `${props.item.effects.creative}%` }}> {props.item.effects.creative}%</div>
                                        </div>
                                        <p className="text-sm font-medium mt-1">focused</p>
                                        <div className="w-full bg-gray-200 rounded-full mt-2 ">
                                            <div className="bg-primaryColor text-xs h-2.7 font-medium text-textColorWhite text-center p-0.5 leading-none rounded-full" style={{ width: `${props.item.effects.focused}%` }}> {props.item.effects.focused}%</div>
                                        </div>
                                        <p className="text-sm font-medium mt-1">THC Level</p>
                                        <div className="w-full bg-gray-200 rounded-full mt-2 ">
                                            <div className="bg-primaryColor text-xs h-2.7 font-medium text-textColorWhite text-center p-0.5 leading-none rounded-full" style={{ width: `${props.item.effects.thc}%` }}> {props.item.effects.thc}%</div>
                                        </div>
                        ...
                        <div className="w-12/12 p-2 ">
                            ...
                            {props.item.extras.length > 0 ?
                                <>
                                    <select id="selectOption" onChange={(e) => handlePrice(e)} class="bg-gray-50 border mt-5 border-gray-300 text-textColor text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div className="w-full flex text-[#4E4E4E] my-5">
                                <button onClick={() => addToCart(props.item._id, 1, price, selectedProductName)} className="w-full rounded px-2 py-2 bg-primaryColor hover:bg-primaryColorHover text-textColor flex justify-between">

                ...
                <div style={{ scrollbarWidth: 'thin' }} className="container h-full mx-auto overflow-y-auto">
                    <div className="grid lg:grid-cols-2 sm:grid-cols-1 h-screen">
                            ...
                            <div className="bg-white flex justify-center items-center">
                                <div className=''>
                                    <button className="bg-transparent self-center hover:bg-[#4E4E4E] text-[#4E4E4E] font-semibold hover:text-white py-2 px-20 border border-[#4E4E4E] hover:border-transparent rounded">
                                        Copy Link
                                    </button>
